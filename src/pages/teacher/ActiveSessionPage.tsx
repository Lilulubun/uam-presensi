    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Button className="mt-4" onClick={() => navigate('/teacher/dashboard')}>
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="bg-card border-b px-4 py-4 flex items-center gap-3">
        <button onClick={() => navigate('/teacher/dashboard')} className="text-muted-foreground hover:text-foreground">
